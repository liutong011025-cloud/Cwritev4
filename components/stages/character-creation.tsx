...
export default function CharacterCreation({ language, onCharacterCreate, onBack, userId }: CharacterCreationProps) {
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-gradient-to-br from-indigo-100 via-purple-50 via-pink-50 to-orange-50 relative" style={{ paddingTop: '120px' }}>
      {/* 高级背景装饰 */}
